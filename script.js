const cardsArray = [
  ...
  },
  {
    ...
    personaje: '',
    imagen: 'https://picsum.photos/300?random=',
    accion: 'Card 4 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam placerat, nisi a porttitor laoreet, nisi eros maximus mi, at malesuada sapien massa et ligula. Aenean id leo non lacus finibus egestas. Curabitur volutpat suscipit sollicitudin. Morbi aliquet diam magna, a elementum turpis ultricies sed. Sed luctus elementum urna, sit amet congue quam pellentesque ut. Vestibulum euismod velit sed velit pretium,'
  },
  {
    id: 5,
    nombre: 'Card 5',
    personaje: '',
    imagen: 'https://picsum.photos/300?random=',
    accion: 'Card 5 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam placerat, nisi a porttitor laoreet, nisi eros maximus mi, at malesuada sapien massa et ligula. Aenean id leo non lacus finibus egestas. Curabitur volutpat suscipit sollicitudin. Morbi aliquet diam magna, a elementum turpis ultricies sed. Sed luctus elementum urna, sit amet congue quam pellentesque ut. Vestibulum euismod velit sed velit pretium,'
  }
]
...
document.querySelector('button').addEventListener('click', function() {
  ...
  const cardGenerated = `
    <div class="card">
      <h2>${randomCard2.nombre}</h2>
      <img src="${randomCard.imagen}${randomCard.id}" alt="${randomCard.nombre}">
      <p class="card-description">${randomCard.accion}</p>
    </div>
  `;
